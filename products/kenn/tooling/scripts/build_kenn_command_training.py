...
def records() -> list[dict[str, Any]]:
    ...
    examples = [
        ...
        ("volume-01", "supported_control", "Set Bass Synth level to minus nine dB", _plan("set_volume", track_index=2, track_name="Bass Synth", value=-9.0, unit="dB")),
        ("volume-02", "supported_control", "Bring the FX Return up to 0 dB", _plan("set_volume", track_index=3, track_name="FX Return", value=0.0, unit="dB")),
