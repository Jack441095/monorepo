...
DEFAULT_PACKET = (
    REPO_ROOT / "docs" / "evidence" / "ABLETON_ASSISTANT_HUMAN_REVIEW_PACKET_2026-09-24.json"
    if (REPO_ROOT / "docs" / "evidence" / "ABLETON_ASSISTANT_HUMAN_REVIEW_PACKET_2026-09-24.json").exists()
    else REPO_ROOT / "docs" / "ABLETON_ASSISTANT_HUMAN_REVIEW_PACKET_2026-09-24.json"
)
DEFAULT_MATRIX = (
