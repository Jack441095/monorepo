...
def plan_for(query: str) -> DiagnosticPlan | None:
    ...
    if (
        ...
        and any(term in text for term in ("dark", "darker", "bright", "brighter", "dull", "duller", "match", "different"))
    ):
        return DiagnosticPlan(
    ...
    if "kick" in text and any(term in text for term in ("bass", "sub", "808")) and any(
        term in text for term in ("disappear", "disappears", "lost", "fight", "conflict", "mask")
    ):
        return DiagnosticPlan(
