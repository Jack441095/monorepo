...
def export_v3_centroids(checkpoint_path, centroids_header_path):
    print(f"Loading checkpoint for centroids: {checkpoint_path}")
    ...
    with open(centroids_header_path, "w") as f:
        f.write("#pragma once\n\n")
        f.write("// Multi-vendor calibrated OOD centroids & thresholds for SLO AcousticClassifier V3.\n")
    ...
    print(f"Successfully exported centroids to {centroids_header_path}")
...
if __name__ == "__main__":
    ...
    export_v3_centroids(ckpt, out_centroids)
