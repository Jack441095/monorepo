...
# Vendored, not imported from audio_too: this standalone extraction has no
# audio_too on its path. See thursday/_compat.py and
# docs/EXTRACTION_COUPLING.md.
from thursday._compat import PublicError, PublicErrorCode
