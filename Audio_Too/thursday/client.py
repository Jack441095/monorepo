...
def marketing_agent(sub_command: str, text: str) -> str:
    return _run_agent("Marketing", sub_command, text)


def research_agent(sub_command: str, text: str) -> str:
    return _run_agent("Research", sub_command, text)
